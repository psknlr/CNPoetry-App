...
- **意象档案** —— 50 个意象：字形封面、异形词、情感光谱（支撑数计量 + 例句回源）、
  ...
  逐条点击进入全诗并朱砂高亮命中句。
- **文库** —— **分层书架**（9 朝代 → 17 集部 → 子目）：集部页可按作者筛选，
...
- **创作实验室** —— 四页签：**诗谱**（五/七言绝句律诗 × 四起式标准谱，○●△符号谱）、
  ...
  **校验**（两种模式：*近体诗* —— 草稿逐句比对四起式，标出违律字位，检三平尾/三仄尾、
  韵脚归部一致性、与古人撞句并可回源对照；*依词谱填词* —— 点选词牌后逐字对谱位校验，
  格内小字示谱位、朱砂标出律、青标韵位，并核韵位归部）。
